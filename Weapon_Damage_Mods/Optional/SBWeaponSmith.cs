    ...
    { 
        ...
        { 
            ...
            { 
                ...
                Add(new GenericBuyInfo(typeof(CrudeSharpeningStone), 10, 20, 0x0F8B, 0));
                Add(new GenericBuyInfo(typeof(SimpleSharpeningStone), 20, 20, 0x0F8B, 0));
                Add(new GenericBuyInfo(typeof(FineSharpeningStone), 50, 20, 0x0F8B, 0));
                Add(new GenericBuyInfo(typeof(SuperiorSharpeningStone), 100, 20, 0x0F8B, 0));

                Add(new GenericBuyInfo(typeof(CrudeWeightStone), 10, 20, 0x0F7F, 2101));
                Add(new GenericBuyInfo(typeof(SimpleWeightStone), 20, 20, 0x0F7F, 2101));
                Add(new GenericBuyInfo(typeof(FineWeightStone), 50, 20, 0x0F7F, 2101));
                Add(new GenericBuyInfo(typeof(SuperiorWeightStone), 100, 20, 0x0F7F, 2101));
